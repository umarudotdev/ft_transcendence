...
export class PlanetRenderer {
	...
	updateRendererConfig(rendererConfig: RendererConfig): void {
		this.rendererConfig = rendererConfig;
		this.axes.visible = rendererConfig.showAxes;
		this.forceFieldMaterial.uniforms['uOpacityFront']!.value = rendererConfig.forceFieldOpacity;
		this.forceFieldMaterial.uniforms['uOpacityBack']!.value = rendererConfig.forceFieldBackFade;
	}
