...
First, you will have to create a comprehensiveREADME.mdfile. The detailed requirements
...
- Store credentials (API keys, environment variables, etc.) in a local.envfile that is
  ignored by Git, and provide an.env.examplefile.
